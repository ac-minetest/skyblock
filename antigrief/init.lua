...
-- prevents placing of lava/liquid sources or buckets above 4 - for skyblock
...
prevent_place_above("darkage:mud");
prevent_place_above("darkage:mud");
prevent_place_above("boneworld:acid_source_active");
end
)