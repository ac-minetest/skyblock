...
local oredefs = {
	...
	mithril = {
		...
		tools = {
			...
			shovel = {
				crumbly = {times = {[1] = 0.70, [2] = 0.35, [3] = 0.20}, uses = 200, maxlevel= 4}
			},
			axe = {
				choppy = {times = {[1] = 1.75, [2] = 0.45, [3] = 0.45}, uses = 200, maxlevel= 4},
				fleshy = {times = {[2] = 0.95, [3] = 0.30}, uses = 200, maxlevel= 1}
			},
			sword = {
				fleshy = {times = {[2] = 0.65, [3] = 0.25}, uses = 200, maxlevel= 4},
				snappy = {times = {[2] = 0.70, [3] = 0.25}, uses = 200, maxlevel= 4},
				choppy = {times = {[3] = 0.65}, uses = 200, maxlevel= 4}
			}
		},
