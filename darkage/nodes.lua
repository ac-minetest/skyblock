...
minetest.register_node("darkage:mud", {
	...
	drowning = 1,
	liquidtype = "source",
	liquid_alternative_flowing = "darkage:mud_flowing",
	liquid_alternative_source = "darkage:mud",
	liquid_viscosity = 20,
...
minetest.register_node("darkage:mud_flowing", {
	description = "Flowing Mud",
	drawtype = "flowingliquid",
	tiles = {"darkage_mud_top.png", "darkage_mud.png"},
	special_tiles = {
		{
			name = "darkage_mud_top.png",
...
minetest.register_node("darkage:darkdirt", {
	description = "Dark Dirt",
        --drop = "default:dirt", --rnd: skyblock quest fix
